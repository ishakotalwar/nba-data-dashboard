...
similarity, shot charts, team tables, and an explorer over every player-season.
The Ask box turns a question turns natural language questions into queries.
...
Data is ESPN's via hoopR and wehoop, about 14 MB of Parquet in `data/`, and it's
...
- ESPN publishes no possession data, so ortg/drtg/pace are team-level only.
